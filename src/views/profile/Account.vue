        ...
        <TabGroup>
          <TabList class="flex bg-white justify-center">
            <Tab v-for="category in categories" as="template" :key="category" v-slot="{ selected }">
              <button class="font-semibold border-b-2 border-white" :class="[
          ...
          <TabPanels class="mt-10">
            ...
            <TabPanel>
              <div class="p-5">
                ...
                <p class="border-b border-gray-300 pb-10 mb-8">Lorem ipsum dolor sit amet consectetur adipisicing elit.
                  Eveniet, commodi quam! Provident quis voluptate asperiores ullam, quidem odio pariatur. Lorem ipsum,
                  dolor sit amet consectetur adipisicing elit. Voluptatem, nulla eos? Cum non ex voluptate corporis id
                  asperiores doloribus dignissimos blanditiis iusto qui repellendus deleniti aliquam, vel quae eligendi
                  explicabo.</p>
                <div class="grid grid-cols-12 gap-5 border-b border-gray-300 pb-10 mb-10">
                  <div class="col-span-12 sm:col-span-6 md:col-span-4">
                    <p class="text-purple-500 mb-1"><i class="i-Calendar text-base"></i><span class="ml-1">Birth
                        Date</span></p><span>1, Jan 1994</span>
                  </div>
                  <div class="col-span-12 sm:col-span-6 md:col-span-4">
                    <p class="text-purple-500 mb-1"><i class="i-MaleFemale text-base"></i><span
                        class="ml-1">Gender</span></p><span>1, Jan 1994</span>
                  </div>
                  <div class="col-span-12 sm:col-span-6 md:col-span-4">
                    <p class="text-purple-500 mb-1"><i class="i-Face-Style-4 text-base"></i><span
                        class="ml-1">Profession</span></p><span>Digital Marketer</span>
                  </div>
                  <div class="col-span-12 sm:col-span-6 md:col-span-4">
                    <p class="text-purple-500 mb-1"><i class="i-Calendar text-base"></i><span class="ml-1">Birth
                        Date</span></p><span>1, Jan 1994</span>
                  ...
                  <div class="col-span-12 sm:col-span-6 md:col-span-4">
                    <p class="text-purple-500 mb-1"><i class="i-Globe text-base"></i><span class="ml-1"> Lives In
                      </span></p><span>8 Years</span>
                  </div>
                  <div class="col-span-12 sm:col-span-6 md:col-span-4">
                    <p class="text-purple-500 mb-1"><i class="i-Edit-Map text-base"></i><span class="ml-1">Email</span>
                    </p><span>example@ui-lib.com</span>
                  </div>
                  <div class="col-span-12 sm:col-span-6 md:col-span-4">
                    <p class="text-purple-500 mb-1"><i class="i-Professor text-base"></i><span class="ml-1">
                        Experience</span></p><span>8 Years</span>
                  </div>
                </div>
                <div class="my-5">
              ...
              <div class="grid grid-cols-12 gap-5">
                <div class="col-span-12 xl:col-span-3 lg:col-span-4 md:col-span-6">
                  <BaseCard class="text-center">
                    <img class="w-20 h-20 m-auto rounded-full shadow-lg mb-3" src="/images/faces/16.jpg" alt=""
                      srcset="" />
                ...
                <div class="col-span-12 xl:col-span-3 lg:col-span-4 md:col-span-6">
                  <BaseCard class="text-center">
                    <div class="card-body text-center">
                      <img class="w-20 h-20 m-auto rounded-full shadow-lg mb-3" src="/images/faces/2.jpg" alt=""
                        srcset="" />
                ...
                <div class="col-span-12 xl:col-span-3 lg:col-span-4 md:col-span-6">
                  <BaseCard class="text-center">
                    <div class="card-body text-center">
                      <img class="w-20 h-20 m-auto rounded-full shadow-lg mb-3" src="/images/faces/3.jpg" alt=""
                        srcset="" />
                ...
                <div class="col-span-12 xl:col-span-3 lg:col-span-4 md:col-span-6">
                  <BaseCard class="text-center">
                    <div class="card-body text-center">
                      <img class="w-20 h-20 m-auto rounded-full shadow-lg mb-3" src="/images/faces/4.jpg" alt=""
                        srcset="" />
